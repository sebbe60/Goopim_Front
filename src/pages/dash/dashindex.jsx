...
const usercreatedmilestoneicon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
const items = [
  ...
  { name: "Withdrawals", icon: withdrawalicon },
...
const IndexPage = () => {
  ...
  return (
    <div className="flex mt-12 bg-[#f2f5f8]">
      <Sidebar
        items={items}
        onItemClick={handleItemClick}
        selectedItem={selectedItem}
      />
      <ViewPanel selectedItem={selectedItem} />
    </div>
  );
};
